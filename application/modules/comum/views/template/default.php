...
<head>
    ...
    <meta name="theme-color"
        content="<?php echo isset($company->colors->primary) ? $company->colors->primary : '#000000'; ?>" />
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
        href="<?php echo base_img('icon/apple-touch-icon-144x144-precomposed.png'); ?>">
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
        href="<?php echo base_img('icon/apple-touch-icon-114x114-precomposed.png'); ?>">
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
        href="<?php echo base_img('icon/apple-touch-icon-72x72-precomposed.png'); ?>">
    <link rel="apple-touch-icon-precomposed"
        href="<?php echo base_img('icon/apple-touch-icon-57x57-precomposed.png'); ?>">
    ...
    <meta name="msapplication-TileImage"
        content="<?php echo base_img('icon/apple-touch-icon-144x144-precomposed.png'); ?>">
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=<?php echo $company->google_tag_manager; ?>"
