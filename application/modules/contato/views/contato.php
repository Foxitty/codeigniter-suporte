    ...
    <div class="common-limiter">
        <section id="infos">
            <div class="infos-wrapper">
                <a class="infos-item"
                    href="<?= 'https://www.google.com/maps?q=loc:(' . $company->latitude . ',' . $company->longitude . ')' ?>"
                    target="_blank">
                    <div class="icon"><?= load_svg('pin.svg') ?></div>
                    <div class="title"><?= $company->address . ', ' . $company->city . ' - ' . $company->country ?>
                    </div>
                </a>
                ...
                <div class="infos-item">
                    ...
                    <div class="title"><a href="tel:<?= $company->phone ?>"><?= $company->phone ?></a></div>
                </div>
        ...
        <section id="form">
            ...
            <form action="<?= site_url($langLinks['contato-send']); ?>" id="contact-form" method="POST"
                novalidate="novalidate" class="common-form ajax-form">
                ...
                <div class="row">
                    <div class="field">
                        ...
                        <textarea name="message" id="textMessage"
                            required><?= isset($product->title) ? (T_('Olá! Gostaria de solicitar um orçamento para o produto') . ' ' . $product->title . '.') : '' ?></textarea>
                    </div>
                </div>
